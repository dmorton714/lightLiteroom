...
contrast, highlight recovery, shadow recovery, blacks, whites), then exports
back to the device. See readme.md for the source spec.
...
2. Check it against the adjustment list above — if it's not import, one of
   the seven adjustments, or export, flag it as out of scope and ask before
   including it.
